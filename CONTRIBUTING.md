...
First off, thank you for considering contributing to genify.
...
[issue tracker](https://github.com/daxartio/genify/issues),
...
```shell
git clone https://github.com/daxartio/genify
cd genify
cargo test
```
